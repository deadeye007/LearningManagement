...
$content .= '<div class="col-md-4"><div class="card"><div class="card-body"><h5 class="card-title">New Users (30 days)</h5><h3>' . $recent_users . '</h3></div></div></div>';
$content .= '<div class="col-md-4"><div class="card"><div class="card-body"><h5 class="card-title">Recent Completions (30 days)</h5><h3>' . $recent_completions . '</h3></div></div></div>';
$content .= '</div>';
